...
/*if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Prepare and execute the SQL query
    $sql = "INSERT INTO request (vehicle_registration, issue_desc, county, sub_county, contact_address, req_date, req_time)
            VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="feebacks.php" method="post" class="advanced-form">
                    <!-- Form fields go here -->
