...
//retrieve information from vehicleowners tables
...
<body>
    ...
    <table>
        ...
        <tbody>
          <!-- Add this part to your existing HTML code where you want to display the service history table -->
<div class="container-fluid">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            $sql = "SELECT id, vehicle_model, vehicle_registration, issue_desc, mechanic_assigned, service_cost, req_date, req_time, status FROM request WHERE contact_email=?";
            ...
            if ($stmt->error) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='9'>No service history found</td></tr>";
                }
