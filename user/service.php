 ...
 <form role="form" class="form-horizontal" >
    <div class="form-group">
     <label for="serviceType">Service type:</label>
            <select id="serviceType" name="country" required>
                <option value="">Type of Service</option>
                <option value="usa">Change oil</option>
                <option value="canada">Engine Service</option>
                <option value="uk">Wheel repair</option>
