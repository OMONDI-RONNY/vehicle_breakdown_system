...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td class='action-buttons'>
                            <a href='userview.php?action=view&id=" . $row['id'] . "' class='view-btn'><i class='fas fa-eye'></i> View</a>
                            <a href='usersedit.php?action=edit&id=" . $row['id'] . "' class='edit-btn'><i class='fas fa-edit'></i> Edit</a>
                            <a href='usersdelete.php?action=delete&id=" . $row['id'] . "' class='delete-btn' onclick='return confirm(\"Are you sure?\");'><i class='fas fa-trash-alt'></i> Delete</a>
                        </td>
                      </tr>";
            }
        } else {
        ...
        $sqlCount = "SELECT COUNT(*) AS total FROM vehicleowners";
        ...
        for ($i = 1; $i <= $totalPages; $i++) {
            echo "<a href='users.php?page=$i&limit=$limit'";
            if ($page == $i) {
                echo " class='active'";
            }
            echo ">$i</a>";
    ...
    <script>
        ...
        function changeLimit(value) {
            ...
            window.location.href = 'users.php?search=' + searchInput + '&limit=' + value;
        }
    </script>
