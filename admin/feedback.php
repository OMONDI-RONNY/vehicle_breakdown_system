            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td class='action-buttons'>
                            <a href='feedbackview.php?action=view&id=" . $row['id'] . "' class='view-btn'><i class='fas fa-eye'></i> View</a>
                            
                            <a href='feedbackdelete.php?action=delete&id=" . $row['id'] . "' class='delete-btn' onclick='return confirm(\"Are you sure?\");'><i class='fas fa-trash-alt'></i> Delete</a>
                        </td>
                      </tr>";
            }
        } else {
