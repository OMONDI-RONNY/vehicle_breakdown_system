...
$sql = "SELECT id, category, status, date_created FROM categories";
if (!empty($search)) {
      ...
      <style>
       body {
        ...
        .add-service-link {
            ...
            cursor: pointer;
             /* Adjust margin top to move it down */
        }
  ...
  <div class="content-wrapper">
    ...
    <form id="searchForm" method="GET">
        <div style="display: flex;margin-left: 10%; align-items: center;">
           ...
           <a style="margin-left: 10%;" href="#" id="openModal">+ Add Category</a>
        </div>
    </form>
    ...
    <table id="servicesTable">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='categoridelete.php?id=".$row['id']."' class='delete-button'>Delete</a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
